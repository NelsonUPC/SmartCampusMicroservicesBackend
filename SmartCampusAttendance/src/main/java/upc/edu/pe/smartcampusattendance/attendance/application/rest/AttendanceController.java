...
public class AttendanceController {
    ...
    @PutMapping("/{sessionId}/full-update")
    public ResponseEntity<AttendanceSession> updateFullSession(
            @PathVariable Long sessionId,
            @RequestBody AttendanceSessionRequest request) {
        return ResponseEntity.ok(service.updateFullSession(sessionId, request));
    }
}
